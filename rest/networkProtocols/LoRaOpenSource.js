...
exports.pullCompanies = function (sessionData, network, dataAPI) {
    return new Promise(async function (resolve, reject) {
        ...
        var options = {};
        options.method = 'GET';
        options.url = network.baseUrl + "/organizations" + "?limit=100&offset=0";
        options.headers = {
            "Content-Type": "application/json",
            "Authorization": "Bearer " + sessionData.connection
        };
...
// Add a remote company's protocol data.
//
// sessionData     - The session information for the user, including the
//                   connection data for the remote system.
// network         - The networks record for the network that uses this
//                   protocol.
// remoteOrganization - The organization as it lives on the LoRa server
//
// localCompany    - The local company record.
//
// dataAPI         - Gives access to the data records and error tracking for the
//                   operation.
//
