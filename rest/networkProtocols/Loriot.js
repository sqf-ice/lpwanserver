...
// The login account data needed to manipulate applications.  For Loriot
...
//           For Loriot, this is a company account.
...
// The login account data needed to manipulate devices.  For Loriot
// Source, this is the company admin account.
//
// dataAPI  - The API that handles common data access and manipulation
//            functions on behalf of the protocol.
...
// The login account data needed to manipulate deviceProfiles.  For Loriot
// Source, this is the company admin account.
//
// dataAPI         - The API that handles common data access and manipulation
//                   functions on behalf of the protocol.
// network         - The network that we are to get the application account info
//                   for. For Loriot, this is a company account.
...
function getDeviceById (network, deviceId, connection, dataAPI) {
  appLogger.log('Loriot: getDeviceProfileById')
...
// Pull data from the Loriot Network
//
...
// Loriot does not support companies.
...
//* *****************************************************************************
// Loriot Does not Support Device Profiles
//* *****************************************************************************
